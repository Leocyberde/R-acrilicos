...
export const localClient = {
  entities: {
    ...
    BudgetLayoutConfig: createEntityClient('BudgetLayoutConfig'),
    ReceiptLayoutConfig: createEntityClient('ReceiptLayoutConfig'),
    WorkOrderLayoutConfig: createEntityClient('WorkOrderLayoutConfig'),
